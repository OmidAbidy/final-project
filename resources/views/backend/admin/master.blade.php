...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    @can('isadmin')
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('admin.proposals.index') }}">Proposals</a>
                        </li>
                    @endcan
                    @can('isfreelancer')
                        <li class="nav-item"><a class="nav-link" href="{{ route('freelancer.profile') }}">My Profile</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('proposals.index') }}">My Proposals</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('freelancer.jobs.index') }}">View Jobs</a>
                        </li>
                    @endcan
                    @can('isclient')
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('proposals.index') }}">Proposals</a></li>
                    @endcan
                    <li class="nav-item">
                        {{ auth()->user()->role }}
                    </li>
    ...
    <!-- Scripts -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>  <!-- Full version -->
